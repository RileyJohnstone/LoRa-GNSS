...
void setup() {
  ...
  response &= myGNSS.addCfgValset(UBLOX_CFG_MSGOUT_RTCM_3X_TYPE1005_UART2, 1);  //Enable message 1005 to output through I2C port, message every second
  ...
  //if (myGNSS.packetUBXNAVSVIN->data.active > 0) // Or we could read active directly
  {
    ...
    uint32_t observationTime = 60;
    float requiredAccuracy = 5.0;  //  60 seconds, 5.0m
